    ...
    <div className='max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300'>
        <form onSubmit={updateCourse} className='my-10'>
            <div className='flex flex-col'>
                ...
                <button type='submit' className='w-full py-3 font-bold text-white bg-indigo-500 hover:bg-indigo-600 rounded-lg border-indigo-500 hover:shadow'>Edit</button>
                <button type='button' onClick={goBack} className='w-full py-3 font-bold text-white bg-red-400 hover:bg-red-500 rounded-lg border-indigo-500 hover:shadow'>Cancel</button>
            </div>
        </form>
    </div>
  )
